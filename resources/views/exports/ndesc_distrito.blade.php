{{-- Hoja: Distrito (Resumen + Personal) --}}
@php
    $norm = function ($s) {
        $s = trim((string)$s);
...
<table>
    <tr>
        <td colspan="10"><strong>Distrito: {{ $distrito }} — NDESC Z{{ $zona }} / {{ $subzonaNombre }}</strong></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td colspan="10"><strong>Personal — {{ $distrito }}</strong></td>
    </tr>
</table>
