                            ...
                            <div class="h-full overflow-y-auto lg:overflow-hidden p-4">        
                                ...
                                <form method="GET" action="{{ route('usuarios.index') }}" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                                        ...
                                        <div>
                                            <label for="nomenclatura_efectiva" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Unidad</label>
                                            <select name="nomenclatura_efectiva" id="nomenclatura_efectiva" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">>
                                                <option value="">-- Todos --</option>
                                                @foreach($nomenclatura_efectiva as $uni)
